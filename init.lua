...
vim.keymap.set('n', '<leader>fb', require('telescope.builtin').current_buffer_fuzzy_find, { desc = '[F]ind in current [B]uffer' })
...
vim.keymap.set('n', '<leader>s/', require('telescope.builtin').search_history, { desc = '[S] [/] search-history' })
...
--vim.keymap.set("n", "<leader>ef", ":NvimTreeFindFile<CR>") -- open file explorer and locate file
